...
ballon = Creation.create!(name: 'Ballon', longueur: 90, largeur: 63, tissue_type: "test", video_link: "test link", patron_link: "ballon.pdf", tagline: "Ce ballon devient un objet ludique unique et résistant ", description:"La housse est lavable, réutilisable à l’infini et constitue également une excellente idée de cadeau pour l’anniversaire
